...
# 1. Get weather data
latitude = 31.520370   # Lahore latitude
longitude = 74.358749  # Lahore longitude
today = datetime.now()
...
plt.title('Lahore Weather - Past Week')
plt.legend()
...
plt.savefig('data/lahore_weather_chart.png')
df.to_csv('data/lahore_weather.csv', index=False)
